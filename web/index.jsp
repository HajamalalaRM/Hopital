        ...
        <div class="row">
            <div class="col">
                <section class="login-clean">
                    <form method="post" style="background-color: lightgreen;" action="Patient.jsp">
                        ...
                        <div class="mb-3"><input class="form-control" type="email" name="nom" placeholder="Nom d'utilisateur"></div>
