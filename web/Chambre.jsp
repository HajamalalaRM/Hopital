...
<body>
    <div class="container-fluide">
        ...
        <div class="row">
            ...
            if(request.getParameter("insertpatient") != null){
                Patient p = new Patient();
                p.setId((Integer)request.getAttribute("idpatient"));
                Integer idserv = (Integer)request.getAttribute("idservice");
                %>
                ...
                <div class="row">
                    <div class="col">
                        <div>
                            <div class="row">
                                <div class="col-xl-12">
                                    <div style="text-align: center;"><label class="form-label" style="font-size: 30px;margin-top: 20px;">Chambres</label></div>
                        ...
                        <div style="margin-top: 40px;margin-bottom: 70px;">
                           <div class="table-responsive">
                               <table class="table">
                                   ...
                                   <tbody>
            <%
                Vector<Chambre> ch = (Vector<Chambre>)request.getAttribute("chambres"); 
                for(int i=0;i<ch.size();i++){
            %>
            <tr>
                <form>
                <td><%= ch.get(i).getNumero() %></td>
                <td><%= ch.get(i).getCategorie() %></td>
                <td><%= ch.get(i).getPrixsejour() %></td>
                <td><%= ch.get(i).getNombre_lit() %></td>
                <td><%= ch.get(i).getLitLibre() %></td> 
                <input type="hidden" name="act" value="chambre">
                <input type="hidden" name="idservice" value="<%= idserv %>">
                <input type="hidden" name="idchambre" value="<%= ch.get(i).getIdchambre() %>">                
                <td><% if(ch.get(i).getLitLibre()>0){ %><button type="submit" >choisir</button><%}%></td>
                </form>
            </tr>
            <%}%>
             </tbody>
